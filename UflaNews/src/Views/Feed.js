                        ...
                        />
                        {
                            ...
                            boletins.map((boletim, index) =>
                                <Boletim
                                    ...
                                    goToComentar={() => this.props.navigation.navigate("VisualizarBoletim", { id: boletim._id, comentar: true })}
                                    key={"feed" + index}
                            ...
                            <View style={{ marginLeft: 20, marginRight: 20 }}>
                                <Text style={styles.tituloLista}>Publicadores:</Text>
                                {
                                    publicadoresFiltrados.map((publicador, index) =>
                                        <Publicador publicador={publicador} goToPublicador={() => this.props.navigation.navigate("Publisher", { id: publicador._id })} />
                                    )
                                }
                            </View>
                        }
